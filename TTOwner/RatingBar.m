...
//    }
    ...
    [_s2 setFrame:CGRectMake(_width,     0, _width, _height)];
    [_s3 setFrame:CGRectMake(2 * _width, 0, _width, _height)];
    [_s4 setFrame:CGRectMake(3 * _width, 0, _width, _height)];
    [_s5 setFrame:CGRectMake(4 * _width, 0, _width, _height)];
...
-(void)displayRating:(float)rating{
    ...
    starRating = rating;
    lastRating = rating;
    [_delegate ratingBar:self Changed:rating];
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    int newRating = (int) (point.x / _width) + 1;
    if (newRating > 5)
        return;
